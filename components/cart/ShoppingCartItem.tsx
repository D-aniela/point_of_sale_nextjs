  ...
  return (
    <li className='flex items-center space-x-6 py-6 relative'>
      ...
      <div className='flex-auto space-y-2'>
        ...
        >
          {/*
           * Array.from crea un array de longitud igual a item.stock
           * y lo recorre con map para crear un array de opciones
           * con valores de 1 a item.stock
           */}
          {Array.from({ length: item.stock }, (_, i) => i + 1).map((i) => (
